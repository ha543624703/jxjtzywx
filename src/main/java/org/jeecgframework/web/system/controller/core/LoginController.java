	...
	public String getPrimaryMenu() {
        ...
        for (TSFunction function : primaryMenu) {
            if(function.getFunctionLevel() == 0){
                ...
                if("Online 开发".equals(function.getFunctionName())){
                ...
                }else if("微信公众平台".equals(function.getFunctionName())){
                	String cs = "<div style='width:67px;position: absolute;top:40px;text-align:center;color:#909090;font-size:12px;'><span style='letter-spacing:-1px;'>"+ "微信公众" +"</span></div>";
                	floor += " <li style='position: relative;'><img class='imag1' src='plug-in/login/images/menu/weixin.png' /> "
                        ...
                        + cs +"</li> ";
                }else if("微信企业号平台".equals(function.getFunctionName())){
                	String cs = "<div style='width:67px;position: absolute;top:40px;text-align:center;color:#909090;font-size:12px;'><span style='letter-spacing:-1px;'>"+ "微信企业" +"</span></div>";
                ...
                }else if("支付窗平台".equals(function.getFunctionName())){
                	String cs = "<div style='width:67px;position: absolute;top:40px;text-align:center;color:#909090;font-size:12px;'><span style='letter-spacing:-1px;'>"+ "支付窗口" +"</span></div>";
