package own.consumerinfo.entity;
 ...
 */
@Entity
@Table(name = "own_consumerinfo", schema = "")
@SuppressWarnings("serial")
public class OwnConsumerinfoEntity implements java.io.Serializable {
	/**主键*/
