...
<head>
    ...
    <title>云联微信管理系统</title>

    <meta name="keywords" content="云联 微信管理系统">
    <meta name="description" content="云联 微信管理系统">
	...
	<style>
	.minimalize-styl-2{margin:20px 5px 5px 20px;}
	.form-group h1{font-size:22px; color:#000; line-height:60px;margin:0px;}
	</style>
</head>

<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden;background:#fff;font-family:'Microsoft YaHei';">
<div id="wrapper">
    <!--左侧导航开始-->
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header" style="padding: 14px 25px;">
                    <div class="dropdown profile-element">
                        <span><img alt="image" width="110%" src="plug-in/weixin/logo/logo_jw.png" /></span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="javascript:add('修改密码','userController.do?changepassword','',550,200)">修改密码</a></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">版权所有:<span class="tip"><a href="http://www.jxylgk.com" target="_blank" title="江西云联高科有限公司">江西云联高科有限公司</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:0791-88179036</span>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<script>
    ...
    function toJeecgYun(){
    	window.open("http://www.jxylgk.com","_blank");
    }
