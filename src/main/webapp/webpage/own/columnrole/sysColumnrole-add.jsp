...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="sysColumnroleController.do?doAdd" tiptype="3">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="columnId" name="columnId"
			...
			<tr>
				...
				<td class="value"><input id="columnName" name="columnName"
					type="text" style="width: 150px" datatype="*" /> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><t:dictSelect field="roleId" type="select"
						id="roleId" dictTable="t_s_role" dictField="id"
						dictText="rolename" defaultVal="${sysColumnrolePage.role_id}"
						hasLabel="false" title="所属角色"></t:dictSelect> <input id="roleName"
					name="roleName" type="hidden"
					value="${sysColumnrolePage.roleName }" /> <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">所属角色</label></td>
			</tr>
		</table>
	</t:formvalid>
</body>
