...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="sysColumntypeController.do?doAdd" tiptype="3">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="typeid" name="typeid" type="text"
			...
			<tr>
				...
				<td class="value"><input id="typename" name="typename"
