		 		...
		 		<div class="inner">
					...
					<table cellpadding="0" cellspacing="1" class="formtable">
						...
						<tr>
							...
							<td class="value">
							<c:if test="${!empty columnid&&columnid!=''}">
							
								<t:dictSelect field="columnId" dictTable="weixin_cms_menu where accountid='${accountid}' and id in(${columnid})" dictField="id" dictText="name" defaultVal="${cmsArticlePage.columnId}"></t:dictSelect>
							</c:if>
							<c:if test="${empty columnid||columnid==''}">
								<t:dictSelect field="columnId" dictTable="weixin_cms_menu where accountid='${accountid}'" dictField="id" dictText="name" defaultVal="${cmsArticlePage.columnId}"></t:dictSelect>
								</c:if>
								<span class="Validform_checktip"></span>
